...
let VideoComponent = class VideoComponent {
    constructor(http, vService, cookieService, numberPipe, route) {
        this.http = http;
        ...
        this.sumUpCost = (arr) => Number(Object.values(arr).reduce((a, b) => (Number(a) + Number(b))));
    }
    ...
    refreshPlayback() {
        ...
        this.audioElement.addEventListener('loadeddata', () => {
            ...
            if (this.isAudioLoaded && this.isVideoLoaded) {
                this.sliderOptions = Object.assign(Object.assign({}, this.sliderOptions), { disabled: false });
                if (that.counter !== 0) {
        ...
        this.videoElement.addEventListener('loadeddata', function () {
            ...
            if (that.isAudioLoaded && that.isVideoLoaded) {
                that.sliderOptions = Object.assign(Object.assign({}, that.sliderOptions), { disabled: false });
                if (that.counter !== 0) {
                    that.videoElement.play();
                    that.audioElement.play();
                }
    ...
    reassignVideoSrc() {
        ...
        this.sliderOptions = Object.assign(Object.assign({}, this.sliderOptions), { disabled: true });
    ...
    priceArrayChange(priceIndex, event) {
