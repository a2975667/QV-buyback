...
let GlobalService = class GlobalService {
    ...
    submit(finalQuestionValue) {
        ...
        if (pathArray[pathIndex + 1]['type'] === 'normal') {
            ...
            return this.http.post(`${this.requestUrl}/submit`, Object.assign(Object.assign({}, submitData), { fileName: currentFileName })).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError)).subscribe(data => {
                this.router.navigate(['likert']);
            });
        }
        else {
