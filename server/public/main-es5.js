        ...
        value: function ngOnInit() {
          ...
          if (type === 'normal') {
            ...
            this.gService.questionSet.subscribe(function (data) {
              ...
              _this9.currentQuestionNum = data.currentQuestion;
              _this9.numQuestion = data.question_list.length;
              var questionContent = data.question_list[_this9.currentQuestionNum];
              ...
              _this9.currentFileNum = pathIndex + 1;
            });
      ...
      _createClass(LikertService, [{
        ...
        value: function isQVTestResultFailed(data) {
          ...
          if (currentFile === 'test_qv') {
            ...
            var _conditions = [data['vet1'] === '(D) This refers to how clear or crisp the visual is in the video.', data['vet2'] === '(E) This refers to how clear or crisp the audio.', data['vet3'] === '(A) It refers to how smooth the visual the video is.', data['vet4'] === '(C) It means how fluent the audio sounds.', data['vet5'] === '(B) It means how perfectly does the visual in the video match with the sound.', data['vet6'] === '(3) apple'];
        ...
        value: function submit(data) {
          ...
          if (this.isQVTestResultFailed(data)) {
            ...
            this.http.post("".concat(this.requestUrl, "/api/disqualify"), {
              ...
              _this16.http.get("".concat(_this16.requestUrl, "/thank_you/thank_attention")).subscribe(function (thankYouData) {
        ...
        value: function ngAfterViewInit() {
          ...
          this.vService.videoForm.subscribe(function (data) {
            if (data) {
              ...
              var userID = _this22.cookieService.get('user_id');
              ...
              _this22.videoSrc = _this22.videoFilePrefix + _this22.formJson['filename'] + '-vq' + _this22.configurations['Video Resolution'] + '.webm?t=' + time + '&userId=' + userID;
              _this22.audioSrc = _this22.audioFilePrefix + _this22.formJson['filename'] + '-av' + _this22.configurations['Audio Quality'] + '.m4a?t=' + time + '&userId=' + userID;
