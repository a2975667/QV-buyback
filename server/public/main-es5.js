      ...
      _createClass(LikertComponent, [{
        ...
        value: function decidePath() {
          ...
          if (type === 'normal') {
            ...
            this.http.get("".concat(this.requestUrl, "/thank_you/").concat(file)).subscribe(function (thankYouData) {
      ...
      _createClass(VideoComponent, [{
        ...
        value: function decidePath() {
          ...
          if (type === 'normal') {
            ...
            var file = pathArray[pathIndex]['file'];
            this.http.get("".concat(this.requestUrl, "/thank_you/").concat(file)).subscribe(function (thankYouData) {
              _this24.route.navigate(['complete', Object.assign({
                userId: userID
              }, thankYouData)]);
            });
          }
          ...
          this.vService.videoForm.subscribe(function (data) {
            if (data) {
              ...
              if (_this25.saveApply.apply) {
                ...
                _this25.configurations["Audio Quality"] = _this25.videoConfig[0];
                _this25.configurations["Video Resolution"] = _this25.videoConfig[1];
                _this25.configurations["Audio Stability"] = _this25.videoConfig[2];
                _this25.configurations["Motion Smoothness"] = _this25.videoConfig[3];
                _this25.configurations["Audio-Video Synchronization"] = _this25.videoConfig[4];
              }
              ...
              _this25.videoSrc = _this25.videoFilePrefix + _this25.formJson['filename'] + '-vq' + _this25.configurations['Video Resolution'] + '.webm?t=' + time + '&userId=' + userID;
              _this25.audioSrc = _this25.audioFilePrefix + _this25.formJson['filename'] + '-av' + _this25.configurations['Audio Quality'] + '.m4a?t=' + time + '&userId=' + userID;
              _this25.videoElement.src = _this25.videoSrc;
              _this25.audioElement.src = _this25.audioSrc;
              setTimeout(function () {
                _this25.sliderOptions = Object.assign({}, _this25.sliderOptions, {
