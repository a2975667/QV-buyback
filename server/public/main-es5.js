                ...
                VideoComponent.prototype.ngAfterViewInit = function () {
                    ...
                    this.vService.videoForm.subscribe(function (data) {
                        if (data) {
                            ...
                            _this.videoSrc = _this.videoFilePrefix + "demo-vq" + _this.configurations['Video Quality'] + ".webm?t=" + time;
                            _this.audioSrc = _this.audioFilePrefix + "demo-aq" + _this.configurations['Audio Quality'] + ".m4a?t=" + time;
