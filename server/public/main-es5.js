        ...
        value: function ngAfterViewInit() {
          ...
          this.vService.videoForm.subscribe(function (data) {
            if (data) {
              ...
              _this22.sliderOptions.disabled = !data.settings.control_panel_can_change;
              ...
              _this22.videoSrc = _this22.videoFilePrefix + 'demo-vq' + _this22.configurations['Video Resolution'] + '.webm?t=' + time;
