...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppLikertLikertComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<div *ngIf=\"!json.survey && !html\">\n\t<app-survey *ngIf=\"json.questions\" [json]=\"json\" (resultEmit)=\"submit($event)\"></app-survey>\n</div>\n<app-survey *ngIf=\"json.questions && !html\" [json]=\"json\" (resultEmit)=\"submit($event)\"></app-survey>\n<div *ngIf=\"html\" class=\"container\">\n    <div [innerHTML]=\"html\"></div>\n    <div class=\"form-check\">\n        <input [(ngModel)]=\"check\" type=\"checkbox\" class=\"form-check-input\" id=\"exampleCheck1\">\n        <label class=\"form-check-label\" for=\"exampleCheck1\">I have read all the instructions above.</label>\n\t\t<br><br>\n    </div>\n    <button (click)=\"submit(null, $event)\" type=\"submit\" class=\"mr-2 btn btn-success\">\n        Submit\n    </button>\n    <span *ngIf=\"errorMessage\">{{errorMessage}}</span>\n</div>\n";
    /***/
  },
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppQuestionnaireQuestionnaireComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<!--<nav class=\"navbar navbar-light bg-light\">\n\t<div class=\"col-sm-2\">\n\t\t<br>\n\t</div>\n\t<div class=\"col-sm\">\n\t\t<div class=\"progress\">\n\t\t\t<div class=\"progress-bar progress-bar-striped progress-bar-animated\"\n\t\t\t\t[style.width.%]=\"(currentQuestionNum+1/numQuestion)*100\"></div>\n\t\t</div>\n\t</div>\n\t<div class=\"col-sm-2\" align=\"right\">\n\t\tPart {{currentFileNum}} Q{{currentQuestionNum+1}} / {{numFile}} Parts\n\t</div>\n</nav>-->\n\n\n<div class=\"container\">\n\t<br>\n\t<h1>{{questionTitle}}</h1>\n\n\t<h4 *ngIf=\"questionTitle=='QV Dry Run: Understanding what is Quadratic Voting'\">Please watch the video below and\n\t\tplay with the QV interface below the video. Once you are ready, click submit and move onto the next page -- you\n\t\twill then need to answer a few questions about the video to show your level of understanding of QV. <br></h4>\n\n\t<video *ngIf=\"questionTitle=='QV Dry Run: Understanding what is Quadratic Voting'\" controls\n\t\tstyle=\" display: block; margin: 0 auto; width: -webkit-fill-available;\">\n\t\t<source src=\"/api/video/qv.webm\"></video>\n\n\n\t<br>\n\t<!--<br>\n\n\t<p *ngIf=\"questionTitle!='QV Dry Run: Understanding what is Quadratic Voting'\"><!--People have different preferences in\n\t\thow important different video elements are. Here we listed 5 different video elements. For each of the elements listed below, <b> how important do you think the video elements were to understanding the video given limited bandwidth on a flight?</b></p>-->\n\t<p *ngIf =\"questionTitle=='QV Dry Run: Understanding what is Quadratic Voting'\">\n\t\tYou will be given a budget of a certain number of <b> voice credits</b>. You will use the available credits to\n\t\tcast votes. If you think a cusine is more favorable, you can cast multiple upvotes using the <b>+1\n\t\t\tsign</b>. If you believe that a cusine is less favorable, you can cast a few downvotes using the <b> -1\n\t\t\tsign</b>. If you are neutral about a cusine, you can choose to cast <b> no vote</b>.\n\t</p>\n\t<p *ngIf =\"questionTitle!='QV Dry Run: Understanding what is Quadratic Voting'\">\n\t\tYou will be given a budget of a certain number of <b> voice credits</b>. You will use the available credits to\n\t\tcast votes. If you think a video element is more important, you can cast multiple upvotes using the <b>+1\n\t\t\tsign</b>. If you believe that an element is less important, you can cast a few downvotes using the <b> -1\n\t\t\tsign</b>. If you are neutral about an element, you can choose to cast <b> no vote</b>.\n\t</p>\n\t<p>\n\t\t<b> Based on the intensity of your opinion, you can cast one or more upvotes or downvotes for each video\n\t\t\telement</b>. The\n\t\tstronger your opinion is, the more votes you can put on one option. At the same time, as the number of votes\n\t\tincreases, the voice credits it costs increase quadratically, i.e. <b> X votes will cost X<sup>2</sup> (square\n\t\t\tof X) credits</b>. The cost of some common number of votes is specified in the table below:\n\t</p>\n\t<table align=\"center\">\n\t\t<tbody>\n\t\t\t<tr align=\"center\">\n\t\t\t\t<th>Number of up or down votes</th>\n\t\t\t\t<td align=\"center\">1</td>\n\t\t\t\t<td align=\"center\">2</td>\n\t\t\t\t<td align=\"center\">3</td>\n\t\t\t\t<td align=\"center\">4</td>\n\t\t\t\t<td align=\"center\">5</td>\n\t\t\t\t<td align=\"center\">6</td>\n\t\t\t\t<td align=\"center\">7</td>\n\t\t\t\t<td align=\"center\">8</td>\n\t\t\t\t<td align=\"center\">9</td>\n\t\t\t\t<td align=\"center\">10</td>\n\t\t\t</tr>\n\t\t\t<!-- <tr align=\"center\">\n\t\t\t\t\t<th align=\"center\">&dArr;</th>\n\t\t\t\t\t<td align=\"center\">&dArr;</td>\n\t\t\t\t\t<td align=\"center\">&dArr;</td>\n\t\t\t\t\t<td align=\"center\">&dArr;</td>\n\t\t\t\t\t<td align=\"center\">&dArr;</td>\n\t\t\t\t\t<td align=\"center\">&dArr;</td>\n\t\t\t\t\t<td align=\"center\">&dArr;</td>\n\t\t\t\t\t<td align=\"center\">&dArr;</td>\n\t\t\t\t\t<td align=\"center\">&dArr;</td>\n\t\t\t\t\t<td align=\"center\">&dArr;</td>\n\t\t\t\t\t<td align=\"center\">&dArr;</td>\n\t\t\t\t</tr> -->\n\t\t\t<tr align=\"right\">\n\t\t\t\t<th align=\"right\">Cost in number of voice credits</th>\n\t\t\t\t<td align=\"center\">1</td>\n\t\t\t\t<td align=\"center\">4</td>\n\t\t\t\t<td align=\"center\">9</td>\n\t\t\t\t<td align=\"center\">16</td>\n\t\t\t\t<td align=\"center\">25</td>\n\t\t\t\t<td align=\"center\">36</td>\n\t\t\t\t<td align=\"center\">49</td>\n\t\t\t\t<td align=\"center\">64</td>\n\t\t\t\t<td align=\"center\">81</td>\n\t\t\t\t<td align=\"center\">100</td>\n\t\t\t</tr>\n\t\t</tbody>\n\t</table>\n\t<p>\n\t\t<br>\n\t\t<b>You cannot exceed the budget of given voice credits, but you do not have to use up all the available credits\n\t\t\teither. </b> You can see the total number of voice credits you have and the number of credits you have spent\n\t\talready in the “Summary” section below.\n\t</p>\n\t<hr>\n\t<div [innerHTML]=\"questionDes\"></div>\n</div>\n<br>\n\n<app-option></app-option>\n\n<br>\n<br>\n\n<app-summary></app-summary>\n<br>\n";
    /***/
  },
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      ...
      providers: [ngx_cookie_service__WEBPACK_IMPORTED_MODULE_12__["CookieService"], _angular_common__WEBPACK_IMPORTED_MODULE_22__["DecimalPipe"]],
  ...
  function srcAppCompleteCompleteComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(CompleteComponent, [{
        key: "setCookieExpire",
        value: function setCookieExpire(id, val) {
          var date = new Date();
          date.setTime(date.getTime() + 1 * 1000);
          this.cookieService.set(id, val, date, '/', undefined, false, 'Lax');
        }
      }, {
        key: "ngOnInit",
  ...
  function srcAppLikertLikertComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function LikertComponent(liService, route, cookieService, http) {
      ...
      _createClass(LikertComponent, [{
        ...
        value: function decidePath() {
          ...
          if (type === 'normal') {
            ...
            this.http.post("".concat(this.requestUrl, "/submit"), {
              userId: userId,
              complete: true
            }).subscribe(function (d) {
              _this6.cookieService.deleteAll('/');

              var file = pathArray[pathIndex]['file'];

              _this6.http.get("".concat(_this6.requestUrl, "/thank_you/").concat(file)).subscribe(function (thankYouData) {
                _this6.route.navigate(['complete', Object.assign({
                  userId: userId
                }, thankYouData)]);
              });
            });
        ...
        value: function submit(data, e) {
          ...
          if (this.check || data) {
            ...
            var pathArray = JSON.parse(this.cookieService.get('user_path'));
            var userId = this.cookieService.get('user_id');
            this.liService.submit(Object.assign(Object.assign({}, data), {
              userId: userId,
              jsonFile: pathArray[pathIndex]
      ...
      _createClass(OptionComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.gService.questionSet.subscribe(function (data) {
            _this9.currentQuestionIndex = data.currentQuestion;
            var currentQuestion = data.question_list[_this9.currentQuestionIndex];
            _this9.currentOptions = currentQuestion.options;
            _this9.votes = new Array(_this9.currentOptions.length).fill(0);
            _this9.totalCredits = currentQuestion.totalCredits;

            _this9.gService.votes.subscribe(function (votes) {
              _this9.votes = votes[_this9.currentQuestionIndex];
            });
          });
        }
      }, {
        ...
        key: "modifyVotesByID",
        value: function modifyVotesByID(oIndex, value) {
          var originalVote = this.gService.votesContent[this.currentQuestionIndex][oIndex];
  ...
  function srcAppQuestionnaireQuestionnaireComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function QuestionnaireComponent(gService, route, cookieService, http) {
      ...
      _createClass(QuestionnaireComponent, [{
        ...
        value: function ngOnInit() {
          ...
          if (type === 'normal') {
            ...
            this.gService.questionSet.subscribe(function (data) {
              _this10.questionnaire = data;
              _this10.currentQuestionNum = data.currentQuestion;
              _this10.numQuestion = data.question_list.length;
              var questionContent = data.question_list[_this10.currentQuestionNum];
              _this10.questionDes = questionContent.description;
              _this10.questionTitle = questionContent.question;
              _this10.numFile = pathArray.length;
              _this10.currentFileNum = pathIndex + 1;
            });
            ...
            this.http.post("".concat(this.requestUrl, "/submit"), {
              ...
              _this10.cookieService.deleteAll('/');

              _this10.route.navigate(['complete', {
                userId: userId,
                text: null,
                title: null
              }]);
    ...
    function () {
      ...
      _createClass(DonationService, [{
        ...
        value: function requestOrganizations() {
          ...
          this.http.get(donationAPI).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError)).subscribe(function (data) {
            _this12.organizations.next(data['donation']);
          });
        }
      }, {
        key: "handleError",
        ...
        value: function submit(data) {
          ...
          this.http.get(completeJsonAPI).subscribe(function (completeJSON) {
            var userId = _this13.getCookieById('user_id');

            _this13.cookieService.deleteAll('/');

            var submitAPI = "".concat(_this13.requestUrl, "/submit-donation");

            _this13.http.post(submitAPI, {
              donation: data,
              userId: userId
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(_this13.handleError)).subscribe(function (result) {
              _this13.route.navigate(['complete', Object.assign(Object.assign({}, completeJSON), {
                userId: userId
              })]);
            });
          });
  ...
  function srcAppServicesGlobalServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(GlobalService, [{
        ...
        value: function checkRoute() {
          ...
          if (type === 'normal') {
            ...
            this.http.post("".concat(this.requestUrl, "/submit"), {
              ...
              _this14.http.get("".concat(_this14.requestUrl, "/thank_you/").concat(file)).subscribe(function (thankYouData) {
                _this14.router.navigate(['complete', Object.assign({
                  userId: userId
                }, thankYouData)]);
              });
            });
        ...
        key: "modifyVotesByID",
        value: function modifyVotesByID(qId, oId, value) {
        ...
        value: function getQuestionnaire() {
          ...
          if (this.checkRoute()) {
            ...
            result.subscribe(function (data) {
              ...
              _this15.votesContent = votesArray;
              _this15.usedCreditsArray = new Array(height).fill(0);

              _this15.update();

              _this15.questionSet.emit(Object.assign({
                currentQuestion: Number(currentQuestion)
              }, data));

              _this15.questionnaire = data;
            });
          }
        ...
        value: function submit(finalQuestionValue) {
          ...
          var pathArray = JSON.parse(this.getCookieById('user_path'));
          var pathIndex = Number(this.getCookieById('user_current_path_index'));
          var currentFileName = pathArray[pathIndex];
          ...
          if (nextQuestionIndex >= this.questionnaire.question_list.length) {
            ...
            if (pathArray[pathIndex + 1]['type'] === 'donation') {
              ...
              return this.http.post("".concat(this.requestUrl, "/submit"), {
                ...
                _this16.router.navigate(['donation']);
              });
            }
          }
          ...
          if (pathArray[pathIndex + 1]['type'] === 'normal') {
            ...
            return this.http.post("".concat(this.requestUrl, "/submit"), Object.assign(Object.assign({}, submitData), {
              fileName: currentFileName,
              finalQuestion: finalQuestionValue
            })).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError)).subscribe(function (data) {
              _this16.router.navigate(['likert']);
            });
          } else {
            this.setCookieById('user_current_question_index', String(nextQuestionIndex));
      ...
      _createClass(LikertService, [{
        ...
        value: function isQVTestResultFailed(data) {
          ...
          if (currentFile === 'test_qv') {
            var conditions = [data['qvt1'] === '(T) True', data['qvt2'] === '(F) False', data['qvt3'] === '(F) False', data['qvt4'] === '(F) False', data['qvt5'] === '(4) 20993', data['qvt6'] === '(4) 12345'];
            return this.decideWhetherPassTest(conditions, 2);
          } else if (currentFile === 'test_video_element') {
            var _conditions = [data['vet1'] === '(D) This refers to how clear or crisp the visual is in the video.', data['vet2'] === '(E) This refers to how clear or crisp the audio.', data['vet3'] === '(A) It means how much the visuals in a video stutters.', data['vet4'] === '(C) It means whether the audio sounds choppy or fluent.', data['vet5'] === '(B) It means how perfectly does the visual in the video match with the sound.', data['vet6'] === '(3) An Apple'];
            return this.decideWhetherPassTest(_conditions, 1);
          } else {
            return false;
          }
        }
      }, {
        key: "decideWhetherPassTest",
        value: function decideWhetherPassTest(conditions, minFailedQuestionNumber) {
        ...
        value: function submit(data) {
          ...
          var pathId = this.cookieService.get('user_path_id');
          var pathArray = JSON.parse(this.getCookieById('user_path'));
          ...
          if (this.isQVTestResultFailed(data)) {
            ...
            this.http.post("".concat(this.requestUrl, "/api/disqualify"), {
              ...
              _this18.cookieService.deleteAll('/');

              _this18.http.get("".concat(_this18.requestUrl, "/thank_you/thank_attention")).subscribe(function (thankYouData) {
                _this18.router.navigate(['complete', Object.assign({
                  userId: 'N/A'
                }, thankYouData)]);
              });
            });
  ...
  function srcAppSummarySummaryComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function SummaryComponent(swalTargets, gService) {
        ...
        this.usedCredits = 0;
        this.percentage = 0;
        this.submitForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].minLength(20)]);
      }
      ...
      _createClass(SummaryComponent, [{
        ...
        value: function submitFinalForm() {
          ...
          this.submitSuccessSwal.dismiss().then(function () {
            return _this20.gService.submit(_this20.submitForm.value);
          });
        }
      }, {
        key: "submit",
        ...
        value: function ngOnInit() {
          ...
          this.gService.questionSet.subscribe(function (data) {
            _this21.totalCredits = data.question_list[data.currentQuestion].totalCredits;

            _this21.gService.usedCredits.subscribe(function (usedCredits) {
              _this21.usedCredits = usedCredits[data.currentQuestion];
              var percentage = _this21.usedCredits / _this21.totalCredits * 100;
              _this21.type = 'info';
              _this21.percentage = percentage;
            });
          });
        }
      }]);
  ...
  function srcAppVideoVideoComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".video {\n  width: 100%;\n}\n\n.wrap-content {\n  word-wrap: break-word;\n}\n\n.content {\n  position: relative;\n  width: 100%;\n}\n\n.content video {\n  width: 100%;\n  display: block;\n}\n\n.content:before {\n  content: \"\";\n  background: black;\n  position: absolute;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n}\n\n.original {\n  position: relative;\n  width: 100%;\n}\n\n.original video {\n  width: 100%;\n  display: block;\n}\n\n.original:before {\n  content: \"\";\n  position: absolute;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n}\n\n.wrapper {\n  display: table;\n  width: auto;\n  position: relative;\n  width: 70;\n  -webkit-box-align: center;\n          align-items: center;\n}\n\n.playpause {\n  background-image: url(http://png-4.findicons.com/files/icons/2315/default_icon/256/media_play_pause_resume.png);\n  background-repeat: no-repeat;\n  width: 50%;\n  height: 50%;\n  position: absolute;\n  left: 0%;\n  right: 0%;\n  top: 0%;\n  bottom: 0%;\n  margin: auto;\n  background-size: contain;\n  background-position: center;\n}\n\n::ng-deep .ng5-slider .ng5-slider-tick-legend {\n  white-space: nowrap !important;\n}\n\n.lds-ring {\n  display: inline-block;\n  position: relative;\n  width: 20px;\n  height: 20px;\n}\n\n.lds-ring div {\n  box-sizing: border-box;\n  display: block;\n  position: absolute;\n  width: 16px;\n  height: 16px;\n  margin: 5px;\n  border: 5px solid #000000;\n  border-radius: 50%;\n  -webkit-animation: lds-ring 1.2s cubic-bezier(0.5, 0, 0.5, 1) infinite;\n          animation: lds-ring 1.2s cubic-bezier(0.5, 0, 0.5, 1) infinite;\n  border-color: #000000 transparent transparent transparent;\n}\n\n.lds-ring div:nth-child(1) {\n  -webkit-animation-delay: -0.45s;\n          animation-delay: -0.45s;\n}\n\n.lds-ring div:nth-child(2) {\n  -webkit-animation-delay: -0.3s;\n          animation-delay: -0.3s;\n}\n\n.lds-ring div:nth-child(3) {\n  -webkit-animation-delay: -0.15s;\n          animation-delay: -0.15s;\n}\n\n@-webkit-keyframes lds-ring {\n  0% {\n    -webkit-transform: rotate(0deg);\n            transform: rotate(0deg);\n  }\n  100% {\n    -webkit-transform: rotate(360deg);\n            transform: rotate(360deg);\n  }\n}\n\n@keyframes lds-ring {\n  0% {\n    -webkit-transform: rotate(0deg);\n            transform: rotate(0deg);\n  }\n  100% {\n    -webkit-transform: rotate(360deg);\n            transform: rotate(360deg);\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppVideoVideoComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function VideoComponent(http, vService, cookieService, numberPipe, route) {
        ...
        this.noNeedToFillReasons = true;
        this.isAudioLoaded = true;
        this.isVideoLoaded = true;

        this.sumUpCost = function (arr) {
          return Number(Object.values(arr).reduce(function (a, b) {
      ...
      _createClass(VideoComponent, [{
        ...
        value: function jitterAudio(jitterVal) {
          ...
          this.audioTimerSubscription = this.muteTimer.subscribe(function (val) {
            if (_this23.videoIsPlaying) {
              _this23.audioElement.volume = 0;
              var freshback = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["timer"])(1500);
              freshback.subscribe(function (d) {
                if (_this23.videoIsPlaying) {
                  _this23.audioElement.volume = 1;
                }
              });
            }
          });
        ...
        value: function renderTableTitle(num) {
          if (this.saveApply.save || this.saveApply.apply) {
            return "Quality ".concat(num);
          } else {
        ...
        value: function refreshPlayback() {
          ...
          this.audioElement.addEventListener('loadeddata', function () {
            _this24.isAudioLoaded = true;

            if (_this24.isAudioLoaded && _this24.isVideoLoaded) {
              _this24.sliderOptions = Object.assign(Object.assign({}, _this24.sliderOptions), {
                disabled: false
              });
          ...
          this.videoElement.addEventListener('loadeddata', function () {
            ...
            if (that.isAudioLoaded && that.isVideoLoaded) {
              that.sliderOptions = Object.assign(Object.assign({}, that.sliderOptions), {
                disabled: false
              });
        ...
        value: function reassignVideoSrc() {
          var time = Date.now();
          var userID = this.cookieService.get('user_id');
          this.videoSrc = this.videoFilePrefix + this.formJson.filename + '-vq' + this.configurations['Video Resolution'] + '.webm';
          this.audioSrc = this.audioFilePrefix + this.formJson.filename + '-aq' + this.configurations['Audio Quality'] + '.m4a';
          ...
          this.sliderOptions = Object.assign(Object.assign({}, this.sliderOptions), {
            disabled: true
          });
        ...
        value: function unsubscribeServices() {
          if (this.audioTimerSubscription) {
            this.audioTimerSubscription.unsubscribe();
          }
        ...
        key: "onCheckboxClick",
        value: function onCheckboxClick(value, key) {
          var table = {
            'Audio Quality': [0, 3],
        ...
        value: function ngOnInit() {
          ...
          this.vService.videoForm.subscribe(function (data) {
            if (data) {
              ...
              if (_this25.saveApply.apply) {
                _this25.noNeedToFillReasons = false;
                _this25.videoConfig = JSON.parse(_this25.cookieService.get('video_config'));
                _this25.configurations = {
                  'Audio Quality': _this25.videoConfig[0],
                  'Video Resolution': _this25.videoConfig[1],
                  'Audio Stability': _this25.videoConfig[2],
                  'Motion Smoothness': _this25.videoConfig[3],
                  'Audio-Video Synchronization': _this25.videoConfig[4]
                };
              }

              var userID = _this25.cookieService.get('user_id');

              _this25.description = data.Description;
              _this25.title = data.Title;
              _this25.showCost = data.settings.control_panel_has_price;
              _this25.showConfig = data.settings.control_panel_can_change;
              _this25.showDemoConfig = data.settings.showDemoConfig;
              _this25.showFullConfig = data.settings.showFullConfig;
              var time = Date.now().toString();
              _this25.videoSrc = _this25.videoFilePrefix + _this25.formJson.filename + '-vq' + _this25.configurations['Video Resolution'] + '.webm';
              _this25.audioSrc = _this25.audioFilePrefix + _this25.formJson.filename + '-av' + _this25.configurations['Audio Quality'] + '.m4a';
              _this25.videoElement.src = _this25.videoSrc;
              _this25.audioElement.src = _this25.audioSrc;
              _this25.isVideoLoaded = false;
              _this25.isAudioLoaded = false;
              _this25.sliderOptions = Object.assign(Object.assign({}, _this25.sliderOptions), {
                disabled: true
              });
              _this25.showPanel = data.settings.control_panel_can_change;

              _this25.refreshPlayback();
            }
          });
        }
      }, {
        key: "fetchCheckBoxStatus",
        value: function fetchCheckBoxStatus(key) {
        ...
        value: function decidePath() {
          ...
          if (type === 'normal') {
            ...
            this.http.post("".concat(this.requestUrl, "/submit"), {
              ...
              _this26.http.get("".concat(_this26.requestUrl, "/thank_you/").concat(file)).subscribe(function (thankYouData) {
                _this26.route.navigate(['complete', Object.assign({
                  userId: userId
                }, thankYouData)]);
              });
            });
        ...
        key: "priceArrayChange",
        value: function priceArrayChange(priceIndex, event) {
          var numValue = Number(event.target.value);

          if (event.target.value.toLowerCase().includes('e')) {
        ...
        key: "isAllReasonFilled",
        get: function get() {
          return Object.keys(this.reasonArray).length === 5 && Object.values(this.reasonArray).filter(function (v) {
  ...
  function srcAppWelcomeWelcomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(WelcomeComponent, [{
        ...
        key: "setCookie",
        value: function setCookie(id, val) {
          this.cookieService.set(id, val, undefined, '/', undefined, false, 'Lax');
        }
      }, {
        key: "initCookie",
          ...
          if (this.conditionOne && this.conditionTwo && this.conditionThree) {
            if (!this.cookieService.check('user_id')) {
              ...
              this.gService.getUserID(userGP).subscribe(function (user) {
                _this28.initCookie(user);

                if (user.path_id === 'thank_you') {
                  var userID = _this28.cookieService.get('user_id');

                  _this28.cookieService.deleteAll('/');

                  _this28.router.navigate(['complete', {
                    userId: userID,
                    text: null,
                    title: null
                  }]);
                } else {
                  _this28.router.navigate(['demographic']);
                }
              });
            } else {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/tcheng10/13_Bash/QV-buyback/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
